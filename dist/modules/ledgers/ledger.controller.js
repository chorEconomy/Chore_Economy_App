...
import { BadRequestError, NotFoundError, UnauthorizedError, } from "../../models/errors.js";
import { Kid } from "../users/user.model.js";
import LedgerTransactionService from "./ledger.service.js";
class LedgerController {
    static getLedger = asyncHandler(async (req, res) => {
    ...
    static getLedgers = asyncHandler(async (req, res) => {
        const kid = await Kid.findById(req.user);
        if (!kid) {
            throw new UnauthorizedError("Unauthorized access");
        }
